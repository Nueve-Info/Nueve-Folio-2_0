      ...
      >
        ...
        <div className="grid gap-6 md:gap-8 lg:grid-cols-2 lg:gap-12">
          ...
          <motion.div
            ...
            className="rounded-[2rem] border border-red-500/10 bg-gradient-to-b from-red-500/5 to-surface-grey/30 p-8 shadow-[0_0_30px_-5px_rgba(239,68,68,0.1)] md:p-12"
          >
          ...
          <motion.div
            ...
            className="rounded-[2rem] border border-green-500/10 bg-gradient-to-b from-green-500/5 to-surface-grey/30 p-8 text-nueve-black shadow-[0_0_30px_-5px_rgba(34,197,94,0.1)] md:p-12"
          >
            <h3 className="mb-8 text-nueve-black">
              This course is <span className="text-green-500">for you</span> if:
            </h3>
            <ul className="space-y-6">
